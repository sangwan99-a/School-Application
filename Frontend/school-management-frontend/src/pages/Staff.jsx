...
export default function Staff() {
  ...
  const fetchStaff = async () => {
    setLoading(true);
    try {
  const res = await axios.get("https://school-application-zs1l.onrender.com/api/staff");
      setStaff(res.data);
    } catch (err) {
  ...
  const handleSubmit = async e => {
    ...
    try {
      if (editId) {
  await axios.put(`https://school-application-zs1l.onrender.com/api/staff/${editId}`, form);
      } else {
  await axios.post("https://school-application-zs1l.onrender.com/api/staff", form);
      }
  ...
  const handleDelete = async id => {
    ...
    try {
  await axios.delete(`https://school-application-zs1l.onrender.com/api/staff/${id}`);
      fetchStaff();
    } catch (err) {

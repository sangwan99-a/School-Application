...
const statCards = [
  { title: "Total Classes", value: "8", color: "purple", icon: (
  ...
  { title: "Assignments Due", value: "3", color: "yellow", icon: (
  ...
  { title: "Upcoming Exams", value: "2", color: "blue", icon: (
      ...
      <aside className="fixed left-0 top-0 h-full w-72 bg-white shadow-lg rounded-r-3xl flex flex-col z-20">
        <div className="py-8 px-6 flex flex-col h-full">
          <div className="flex items-center mb-8">
            ...
            <span className="text-2xl font-bold text-gray-800">Teacher Hub</span>
          </div>
          ...
          <div className="mt-auto pt-8 text-xs text-gray-400 text-center">
            &copy; {new Date().getFullYear()} School Teacher
          </div>
        </div>
      </aside>
      {/* Main Content */}
      <main className="flex-1 ml-72 p-8">
        ...
        <header className="mb-8 flex flex-col gap-4">
          <div className="flex items-center justify-between">
            ...
            <span className="text-gray-500 font-medium">Welcome, manage your classes and assignments</span>
          </div>
        </header>
        {/* Main Card */}
        <section className="bg-white rounded-3xl shadow-lg p-8 mb-8">
          ...
          <div className="bg-gray-100 rounded-2xl border-2 border-dashed border-gray-300 min-h-[200px] flex items-center justify-center mb-8">
            <span className="text-gray-400 font-semibold text-xl">Teacher Activity & Classes Table Goes Here</span>
          </div>
          {/* Recent Activity */}
          <div className="mt-8">
            ...
            <ul className="space-y-3">
              <li className="bg-gray-50 rounded-xl p-4 shadow flex items-center gap-3">
                <span className="w-8 h-8 rounded-full bg-purple-400 text-white flex items-center justify-center font-bold text-lg">AS</span>
                <span className="text-gray-700 flex-1">Assignment <b>Science Project</b> due soon</span>
                <span className="text-xs text-gray-400">1d ago</span>
              </li>
              <li className="bg-gray-50 rounded-xl p-4 shadow flex items-center gap-3">
                <span className="w-8 h-8 rounded-full bg-indigo-400 text-white flex items-center justify-center font-bold text-lg">EX</span>
                <span className="text-gray-700 flex-1">Exam <b>Maths Midterm</b> scheduled</span>
